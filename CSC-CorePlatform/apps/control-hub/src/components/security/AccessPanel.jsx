export default function AccessPanel({ onRequestReview, onExportAudit }) {
  return (
    <div style={{ background: "var(--hub-panel)", borderRadius: 20, padding: 18, boxShadow: "var(--hub-shadow)" }}>
      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <button
          ...
          style={{ border: "1px solid var(--hub-line)", borderRadius: 14, padding: "12px 16px", background: "transparent", color: "var(--hub-text)", cursor: "pointer" }}
        >
          Export Audit
        </button>
      </div>
